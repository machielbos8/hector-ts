...
def main():
    ...
    print("\n***************************************")
    print("    simulatenoise, version 3.1.6.")
    print("***************************************")
    ...
    if observations.datafile=='None' and observations.ts_format=='mom':
        ...
        for i in range(1,m):
            t[i] = t[i-1] + dt
    elif observations.datafile=='None' and observations.ts_format=='ncf':
        t = np.zeros(m)
        t[0] = 51544.0  # 1 January 2000 (MJD)
        for i in range(1,m):
            t[i] = t[i-1] + dt
    else:
